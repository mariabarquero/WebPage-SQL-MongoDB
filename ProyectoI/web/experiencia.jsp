<%-- 
    ...
    Created on : 17/10/2020, 09:13:43 AM
    Author     : Mariá José
--%>
     ...
     <body>        
        <header class="header">
          ...
          <div class="container mt-3">
            <form action="ControladorOpinion" method="POST">
              <div class="row">      
                   <div class="col-sm-5">
                        <div class="card">
                            <div class="card-header">
                                <div class="form-group">
                                 ...
                                 <input type="text" name="textCedula" placeholder="Escriba su cédula aquí" class="form-control"> <br>
                                </div>
                                 <div class="form-group">
                                 <label>Escriba su opinión aquí:</label>
                                 <textarea name="descripcion" rows="8" cols="30" class="form-control"></textarea>
                                   </div>
                        </div>
                            ...
                            <div class="card-footer text-center">
                                <div>
                                      ...
                                      <input  type="submit" name="accion" value="Enviar" class="btn btn-outline-info">
                                      <input  type="submit" name="accion" value="Eliminar" class="btn btn-outline-info">
