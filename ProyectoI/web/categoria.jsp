<%-- 
    Document   : categoria
    Created on : 14/10/2020, 10:56:39 AM
    Author     : Mariá José
--%>
...
<html>
    ...
    <body>        
        ...
        <div class="container mt-2">
            <div class="row">
                <c:forEach var="prod" items="${prod_cat}">
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-header">
                                <label>${prod.getNombre_Articulo()}</label>
                            </div>
                            <div class="card-body">
                                <label>${prod.getPrecio_unitario()} <label>
                                <img src="${prod.getImagen()}" width="200" height="180">
                            </div>  
                            <div class="card-footer text-center">
                                <label>${prod.getDescripcion()}</label>
                                <div>
                                    <form action="Controlador" method="POST">
                                        <input type="hidden" name="id" value="${prod.getId_Articulo()}">
